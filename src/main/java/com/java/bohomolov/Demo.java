...
public class Demo {
    public static void main(String[] args) throws Exception {
        ...
        List<ChairWheel> chairWheelList = Arrays.asList(
                new ChairWheel(Material.PLASTIC, Color.RED, Color.BLACK, true, 100),
                new ChairWheel(Material.PLASTIC, Color.RED, Color.BLACK, true, 100),
                new ChairWheel(Material.PLASTIC, Color.RED, Color.BLACK, true, 100),
                new ChairWheel(Material.PLASTIC, Color.RED, Color.BLACK, true, 100),
                new ChairWheel(Material.PLASTIC, Color.RED, Color.BLACK, true, 100)
        ...
        try {
            ...
            switch(exception.getMessage().split(" ")[1]) {
                case "wheels": {
                    gamerChair.setLegs(new ChairWheel(Material.PLASTIC, Color.RED, Color.BLACK, true, 100));
